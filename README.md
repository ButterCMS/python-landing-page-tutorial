# python-landing-page-tutorial
How to Quickly Spin Up Python Landing Pages with ButterCMS

## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Quickly Spin Up Python Landing Pages with ButterCMS](https://buttercms.com/blog/python-landing-page-tutorial/), and will not be actively maintained.
